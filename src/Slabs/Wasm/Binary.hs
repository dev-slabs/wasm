...
encodeCtlInstr (Block bt ins)
  = do B.word8 2
       encodeBlockType bt
       mapM_ encodeInstr ins
       B.word8 11
encodeCtlInstr (Loop bt ins)
  = do B.word8 3
       encodeBlockType bt
       mapM_ encodeInstr ins
       B.word8 11
encodeCtlInstr (If bt in1 in2)
  = do B.word8 4
       encodeBlockType bt
...
encodeCtlInstr (Br l)
  = do B.word8 12
       encodeLabelIdx l
encodeCtlInstr (BrIf l)
  = do B.word8 13
       encodeLabelIdx l
encodeCtlInstr (BrTable ls ln)
  = do B.word8 14
       encodeVec encodeLabelIdx ls
       encodeLabelIdx ln
encodeCtlInstr Return = B.word8 15
encodeCtlInstr (Call x)
  = do B.word8 16
       encodeFuncIdx x
encodeCtlInstr (CallIndirect x y)
  = do B.word8 17
       encodeTypeIdx y
       encodeTableIdx x
...
encodeRefInstr (RefNull t)
  = do B.word8 208
       encodeRefType t
encodeRefInstr RefIsNull = B.word8 209
encodeRefInstr (RefFunc x)
  = do B.word8 210
       encodeFuncIdx x

decodeParamInstr :: Parser ParamInstr
decodeParamInstr
  = "ParamInstr" <?> do P.word8 26
                        pure Drop
                     <|> do P.word8 27
                            pure (Select [])
                     <|> do P.word8 28
...
encodeVarInstr (LocalGet x)
  = do B.word8 32
       encodeLocalIdx x
encodeVarInstr (LocalSet x)
  = do B.word8 33
       encodeLocalIdx x
encodeVarInstr (LocalTee x)
  = do B.word8 34
       encodeLocalIdx x
encodeVarInstr (GlobalGet x)
  = do B.word8 35
       encodeGlobalIdx x
encodeVarInstr (GlobalSet x)
  = do B.word8 36
       encodeGlobalIdx x

decodeTableInstr :: Parser TableInstr
decodeTableInstr
  = "TableInstr" <?> do P.word8 37
                        x <- decodeTableIdx
                        pure (TableGet x)
                     <|> do P.word8 38
                            x <- decodeTableIdx
...
encodeTableInstr (TableGet x)
  = do B.word8 37
       encodeTableIdx x
encodeTableInstr (TableSet x)
  = do B.word8 38
       encodeTableIdx x

decodeTableInstr' :: Parser TableInstr'
decodeTableInstr'
  = "TableInstr'" <?> do checkEq decodeU32 12
                         y <- decodeElemIdx
                         x <- decodeTableIdx
                         pure (TableInit x y)
...
encodeTableInstr' :: TableInstr' -> Builder ()
encodeTableInstr' (TableInit x y)
  = do encodeU32 12
       encodeElemIdx y
       encodeTableIdx x
encodeTableInstr' (ElemDrop x)
  = do encodeU32 13
       encodeElemIdx x
encodeTableInstr' (TableCopy x y)
  = do encodeU32 14
       encodeTableIdx x
       encodeTableIdx y
encodeTableInstr' (TableGrow x)
  = do encodeU32 15
       encodeTableIdx x
encodeTableInstr' (TableSize x)
  = do encodeU32 16
       encodeTableIdx x
encodeTableInstr' (TableFill x)
  = do encodeU32 17
       encodeTableIdx x
...
encodeMemoryInstr (I32Load m)
  = do B.word8 40
       encodeMemArg m
encodeMemoryInstr (I64Load m)
  = do B.word8 41
       encodeMemArg m
encodeMemoryInstr (F32Load m)
  = do B.word8 42
       encodeMemArg m
encodeMemoryInstr (F64Load m)
  = do B.word8 43
       encodeMemArg m
encodeMemoryInstr (I32Load8S m)
  = do B.word8 44
       encodeMemArg m
encodeMemoryInstr (I32Load8U m)
  = do B.word8 45
       encodeMemArg m
encodeMemoryInstr (I32Load16S m)
  = do B.word8 46
       encodeMemArg m
encodeMemoryInstr (I32Load16U m)
  = do B.word8 47
       encodeMemArg m
encodeMemoryInstr (I64Load8S m)
  = do B.word8 48
       encodeMemArg m
encodeMemoryInstr (I64Load8U m)
  = do B.word8 49
       encodeMemArg m
encodeMemoryInstr (I64Load16S m)
  = do B.word8 50
       encodeMemArg m
encodeMemoryInstr (I64Load16U m)
  = do B.word8 51
       encodeMemArg m
encodeMemoryInstr (I64Load32S m)
  = do B.word8 52
       encodeMemArg m
encodeMemoryInstr (I64Load32U m)
  = do B.word8 53
       encodeMemArg m
encodeMemoryInstr (I32Store m)
  = do B.word8 54
       encodeMemArg m
encodeMemoryInstr (I64Store m)
  = do B.word8 55
       encodeMemArg m
encodeMemoryInstr (F32Store m)
  = do B.word8 56
       encodeMemArg m
encodeMemoryInstr (F64Store m)
  = do B.word8 57
       encodeMemArg m
encodeMemoryInstr (I32Store8 m)
  = do B.word8 58
       encodeMemArg m
encodeMemoryInstr (I32Store16 m)
  = do B.word8 59
       encodeMemArg m
encodeMemoryInstr (I64Store8 m)
  = do B.word8 60
       encodeMemArg m
encodeMemoryInstr (I64Store16 m)
  = do B.word8 61
       encodeMemArg m
encodeMemoryInstr (I64Store32 m)
  = do B.word8 62
       encodeMemArg m
encodeMemoryInstr MemorySize
  = do B.word8 63
       B.word8 0
encodeMemoryInstr MemoryGrow
  = do B.word8 64
       B.word8 0

decodeMemoryInstr' :: Parser MemoryInstr'
decodeMemoryInstr'
  = "MemoryInstr'" <?> do checkEq decodeU32 8
                          x <- decodeDataIdx
                          P.word8 0
                          pure (MemoryInit x)
...
encodeMemoryInstr' :: MemoryInstr' -> Builder ()
encodeMemoryInstr' (MemoryInit x)
  = do encodeU32 8
       encodeDataIdx x
       B.word8 0
encodeMemoryInstr' (DataDrop x)
  = do encodeU32 9
       encodeDataIdx x
encodeMemoryInstr' MemoryCopy
  = do encodeU32 10
       B.word8 0
       B.word8 0
encodeMemoryInstr' MemoryFill
  = do encodeU32 11
       B.word8 0
...
decodeNumInstr' :: Parser NumInstr'
decodeNumInstr'
  = "NumInstr'" <?> do checkEq decodeU32 0
